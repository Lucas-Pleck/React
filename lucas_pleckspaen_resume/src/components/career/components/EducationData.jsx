const educationData = [
  {
    title: '2022',
    cardTitle: 'SELF-LEARNING PROGRAM',
    media: {
      name: 'OpenClassRooms logo',
      source: {
        url: 'https://blog.openclassrooms.com/en/wp-content/uploads/sites/4/2018/11/Blog_logo.jpg',
      },
      type: 'IMAGE',
    },
    cardSubtitle: 'OPENCLASSROOM',
  ...
  {
    title: '2021 2022',
    cardTitle: 'DEVOPS SKILLS TRAINING',
    media: {
      name: 'Devops Technocite',
      source: {
        url: 'https://api.technocite.be/static/1637597237668-admin-reseau-service-ip.webp',
      },
      type: 'IMAGE',
    },
    cardSubtitle: `TECHNOCITE`,
    cardDetailedText: ` - Front-End web development
                        - Web servers / SQL servers
                        - Automation and MVC development
                        - Modern development and CI / CD pipeline
                        - Virtualization - Docker - Kubernates
                        - Clusters - CI / CD orchestration - Monitoring
                        - Complex infrastructures and Cloud computing`,
  },
  {
    title: 'June 1941',
